      ...
      >
        {selectedSessionId ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center p-8">
            ...
            <p className="text-sm font-semibold text-foreground">Select an inquiry</p>
            <p className="text-xs text-muted-foreground mt-1 max-w-[280px]">
              Vehicle owners can reply to messages initiated by renters. Select a thread to view logs and reply.
            </p>
          </div>
        )}
      </div>
