    ...
    <div className="flex h-[calc(100vh-112px)] border rounded-xl overflow-hidden bg-card border-border shadow-sm">
      ...
      >
        <div className="p-4 border-b border-border bg-card">
          <h2 className="text-base font-bold text-foreground">Chat Monitor</h2>
        </div>
      ...
      {/* Messages Viewer / Interface Pane (Read-Only) */}
      <div
      ...
      >
        {selectedSessionId ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center p-8">
            ...
            <p className="text-sm font-semibold text-foreground">Admin Chat Viewer</p>
            <p className="text-xs text-muted-foreground mt-1 max-w-[280px]">
              Select any session from the monitor queue. This view is read-only for audit purposes.
            </p>
          </div>
        )}
      </div>
